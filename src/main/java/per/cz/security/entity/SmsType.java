...
public enum SmsType {
	 ...
	 * 用户注册验证码
	 */
	REGISTER(0,"SMS_193233757","您正在申请手机注册，验证码为：${code}，5分钟内有效！"),

	/**
	 * 发送登录验证码
	 */
	LOGIN(1,"SMS_193239178","验证码${code}，您正在登录，若非本人操作，请勿泄露。"),
	/**
	 * 修改密码验证码
	 */
	UPDATE_PASSWORD(2,"SMS_193239184","验证码${code}，您正在尝试修改登录密码，请妥善保管账户信息。"),
	/**
	 * 身份验证验证码
	 */
	VALID(3,"SMS_193244250","验证码${code}，您正在进行身份验证，打死不要告诉别人哦！"),

	/**
	 * 修改手机验证码
	 */
	UPDATE_PHONE(4,"SMS_193239438","您正在申请更换手机号，验证码为：${code}，5分钟内有效！"),
